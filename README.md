# [SOLVED] Iphone-Where-The-Dsym-File-Is-Located-In-Crash-Report
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/iphone-where-the-dsym-file-is-located-in-crash-report)
>
...
The .dSYM file is located in the Xcode project directory, while the application binary is stored in the app's installation location (e.g., /var/stash/ on iOS devices).
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/iphone-where-the-dsym-file-is-located-in-crash-report)**
